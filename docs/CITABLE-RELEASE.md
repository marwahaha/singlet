...
4. Add the assigned DOI to `CITATION.cff` and the site's citation section. Cite the version DOI when reproducing a particular state of the figures or research questions, and the concept DOI for the evolving work.
